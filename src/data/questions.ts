 ...
 *   - réponse "optimale" : replaceability -10
 *   - réponse correcte mais passive : replaceability 0
 *   - réponse risquée : replaceability +15
 *   - réponse catastrophique : replaceability +25
 */
export const questions: Question[] = [
  {
    id: "q-compte-rendu",
    scenario: "Un collaborateur vous envoie un compte-rendu de réunion rédigé par une IA et vous demande de le transmettre immédiatement à un client.",
    assistantHint: "Pense au risque d'erreur factuelle dans une sortie IA. Que se passe-t-il si le client reçoit une information fausse signée de votre nom ?",
    answers: [
      {
        id: "a",
  ...
  },
  {
    ...
    assistantHint: "Le brief est clair : l'IA doit être un levier de performance, pas un substitut au manager. Quelle option respecte ce principe ?",
    answers: [
      {
        id: "a",
  ...
  },
  {
    ...
    assistantHint: "Les modèles grand public peuvent réutiliser les données envoyées pour s'entraîner. Quelles conséquences sur la confidentialité de l'entreprise ?",
    answers: [
      {
        id: "a",
  ...
  },
  {
    ...
    assistantHint: "Une IA peut halluciner. Quel comportement protège votre crédibilité de manager ?",
    answers: [
      {
        id: "a",
  ...
  },
  {
    ...
    assistantHint: "Pense aux tâches à faible valeur ajoutée qui peuvent être déléguées sans risque éthique ou RH.",
    answers: [
      {
        id: "a",
